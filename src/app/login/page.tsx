          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center cursor-pointer touch-manipulation">
              <div className="relative flex items-center">
                ...
                />
                <div className="w-5 h-5 border-2 border-gray-300 rounded bg-white peer-checked:bg-blue-100 peer-checked:border-blue-600 flex items-center justify-center">
                  {rememberMe && (
