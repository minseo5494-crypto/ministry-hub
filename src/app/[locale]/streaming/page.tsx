        ...
        <div className="px-8 pb-32">
            ...
            <>
              ...
              <div className="mb-12">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-2xl font-bold">{t('featuredContent')}</h2>
          ...
          {activeTab === 'explore' && (
            <div className="text-center py-20">
              ...
              <p className="text-slate-400 text-lg">{t('exploreDesc')}</p>
            </div>
          )}
          ...
          {activeTab === 'library' && (
            <div className="text-center py-20">
              ...
              <h2 className="text-3xl font-bold mb-4">{t('libraryTitle')}</h2>
              <p className="text-slate-400 text-lg">{t('libraryDesc')}</p>
            </div>
          )}
        </div>
      </div>
