          ...
          >
            <div className="relative rounded-xl p-4 h-36 flex flex-col justify-between
              ...
              <div>
                ...
                <span className="text-xs" style={{ color: '#4B5563' }}>{translateService(setlist.service_type)}</span>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-1 text-xs" style={{ color: '#374151' }}>
                  <Music size={12} />
                  <span>{t('songCountUnit', { count: setlist.song_count })}</span>
                </div>
                {setlist.songs.length > 0 && (
                  <span className="text-xs truncate max-w-[120px]" style={{ color: '#4B5563' }}>
                    {setlist.songs[0].song_name}{setlist.songs.length > 1 ? ` ${t('songCountMore', { first: '', rest: setlist.songs.length - 1 })}` : ''}
                  </span>
                )}
              </div>
            </div>
