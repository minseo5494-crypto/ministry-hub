        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-lg sm:text-xl font-bold whitespace-nowrap hidden sm:block">{t('pageTitle')}</h1>
            </div>
        ...
        <div className="bg-white rounded-lg shadow p-4 mb-6">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3 mt-3">
            ...
            <select
              ...
              className="flex-1 min-w-[100px] sm:flex-none px-3 sm:px-4 py-2 border rounded-lg text-sm"
            >
              <option value="">{t('allTempos')}</option>
              <option value="느림">{td('tempo_느림')}</option>
              <option value="보통">{td('tempo_보통')}</option>
              <option value="빠름">{td('tempo_빠름')}</option>
            </select>
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-4 border-b">
            <h2 className="text-lg font-bold">
              {t('mySheetCount', { count: filteredSongs.length })}
            </h2>
          </div>
          ...
          {filteredSongs.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-gray-600">{t('noSongsTitle')}</p>
