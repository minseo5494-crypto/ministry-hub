...
import CommunityComments from '@/app/[locale]/community/components/CommunityComments'
import CopyToTeamModal from '@/app/[locale]/community/components/CopyToTeamModal'
...
export default function ExploreDetailPage() {
  ...
  const translateServiceType = (name: string) => {
      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="bg-white rounded-2xl p-5 shadow-sm">
          ...
          <div className="flex flex-wrap items-center gap-1.5 mb-1 text-sm text-gray-600">
            <span>{t('authorSuffix', { name: setlist.author_name })}</span>
          ...
          <div className="flex flex-wrap items-center gap-1.5 text-xs text-gray-400 mb-4">
            ...
            {setlist.service_type && (
              <>
                <span className="text-gray-300">·</span>
                <span>{translateServiceType(setlist.service_type)}</span>
              </>
            )}
          </div>
          ...
          <div className="flex gap-2">
            ...
            >
              ...
              <span>{setlist.is_bookmarked ? t('saved') : t('saveBookmark')}</span>
            </button>
        ...
        <div className="bg-white rounded-2xl p-5 shadow-sm">
          <h2 className="text-base font-bold text-gray-900 mb-4">
            {t('songList', { count: setlist.songs.length })}
          </h2>
        ...
        {setlist.devotional_guide && (
          <div className="bg-white rounded-2xl p-5 shadow-sm">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h2 className="text-base font-bold text-gray-900">{t('devotionalGuide')}</h2>
            </div>
