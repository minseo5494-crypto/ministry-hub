  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-3">
        ...
        <p className="text-sm text-gray-400">{t('loadingPopular')}</p>
      </div>
    )
  }
  ...
  if (songs.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-20 gap-3">
        ...
        <p className="text-gray-500 font-medium">{t('noPopularSongs')}</p>
        <p className="text-sm text-gray-400">{t('noPopularSongsHint')}</p>
      </div>
    )
  }
  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-4">
        ...
        <p className="text-sm text-gray-500">{t('popularDesc')}</p>
      </div>
                  ...
                  <div className="w-8 flex flex-col items-center">
                    {song.youtube_url ? (
                      <button
                        ...
                        title={youtubeStates[song.id] ? t('youtubeClose') : t('youtubeOpen')}
                        style={{ touchAction: 'manipulation' }}
                      >
                        <Youtube size={16} />
                      </button>
      ...
      <p className="text-center text-xs text-gray-400 mt-6">
        {t('totalPopular', { count: songs.length })}
      </p>
