...
import CommunitySetlistCard from '@/app/[locale]/community/components/CommunitySetlistCard'
import CommunityFiltersComponent from '@/app/[locale]/community/components/CommunityFilters'
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-3 flex items-center gap-3">
          ...
          <span className="text-gray-700 font-medium">{t('pageTitle')}</span>
        </div>
      </div>
          ...
          <>
            ...
            <div className="mb-6">
              <div className="flex items-center gap-2 mb-1">
                ...
                <h1 className="text-xl font-bold text-gray-900">{t('sharedSetlistsTitle')}</h1>
              </div>
              <p className="text-sm text-gray-500">{t('sharedSetlistsDesc')}</p>
            </div>
            ...
            {!initialLoaded || loading ? (
              <div className="flex flex-col items-center justify-center py-20 gap-3">
                ...
                <p className="text-sm text-gray-400">{t('loadingSetlists')}</p>
              </div>
            ) : setlists.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-20 gap-3">
                <Music2 size={40} className="text-gray-300" />
                <p className="text-gray-500 font-medium">{t('noSharedSetlists')}</p>
                <p className="text-sm text-gray-400">{t('noSharedSetlistsHint')}</p>
              </div>
            ) : (
              <>
                ...
                <p className="text-center text-xs text-gray-400 mt-4">
                  {t('totalSetlists', { count: setlists.length })}
                </p>
              </>
            )}
          </>
